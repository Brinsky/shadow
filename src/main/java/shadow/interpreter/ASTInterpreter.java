...
public class ASTInterpreter extends BaseChecker {
  ...
  public Void visitConditionalOrExpression(ShadowParser.ConditionalOrExpressionContext ctx) {
    ...
    ctx.setInterpretedValue(
        evaluateBinaryOperation(ctx, ctx.conditionalExclusiveOrExpression(), ctx.operators, true));
  ...
  public Void visitConditionalExclusiveOrExpression(
    ...
    ctx.setInterpretedValue(
        evaluateBinaryOperation(ctx, ctx.conditionalAndExpression(), ctx.operators, true));
  ...
  public Void visitConditionalAndExpression(ShadowParser.ConditionalAndExpressionContext ctx) {
    ...
    ctx.setInterpretedValue(
        evaluateBinaryOperation(ctx, ctx.bitwiseOrExpression(), ctx.operators, true));
  ...
  public Void visitBitwiseOrExpression(ShadowParser.BitwiseOrExpressionContext ctx) {
    ...
    ctx.setInterpretedValue(
        evaluateBinaryOperation(ctx, ctx.bitwiseExclusiveOrExpression(), ctx.operators, true));
  ...
  public Void visitBitwiseExclusiveOrExpression(
    ...
    ctx.setInterpretedValue(
        evaluateBinaryOperation(ctx, ctx.bitwiseAndExpression(), ctx.operators, true));
  ...
  public Void visitBitwiseAndExpression(ShadowParser.BitwiseAndExpressionContext ctx) {
    ...
    ctx.setInterpretedValue(
        evaluateBinaryOperation(ctx, ctx.equalityExpression(), ctx.operators, true));
  ...
  public Void visitEqualityExpression(ShadowParser.EqualityExpressionContext ctx) {
    ...
    ctx.setInterpretedValue(evaluateBinaryOperation(ctx, ctx.isExpression(), ctx.operators, true));
  ...
  public Void visitRelationalExpression(ShadowParser.RelationalExpressionContext ctx) {
    ...
    ctx.setInterpretedValue(
        evaluateBinaryOperation(ctx, ctx.concatenationExpression(), ctx.operators, true));
  ...
  public Void visitConcatenationExpression(ShadowParser.ConcatenationExpressionContext ctx) {
    ...
    // Handled differently from other binary operators since it's allowed between almost any two
    // types
    ShadowValue value = ShadowValue.INVALID;
  ...
  public Void visitAdditiveExpression(ShadowParser.AdditiveExpressionContext ctx) {
    ...
    ctx.setInterpretedValue(
        evaluateBinaryOperation(ctx, ctx.multiplicativeExpression(), ctx.operators, true));
  ...
  public Void visitMultiplicativeExpression(ShadowParser.MultiplicativeExpressionContext ctx) {
    ...
    ctx.setInterpretedValue(
        evaluateBinaryOperation(ctx, ctx.unaryExpression(), ctx.operators, true));
    ...
    if (!ctx.getModifiers().isTypeName()) {
      if (image.equals("this") || image.equals("super"))
        ...
        if (ctx.unqualifiedName() == null) {
          ...
          ShadowParser.VariableDeclaratorContext fieldCtx =
              currentType.recursivelyGetConstant(fieldName);
          if (fieldCtx == null) {
    ...
    if (prefixType instanceof ArrayType
      ...
      try {
        ...
        if (index < 0 || index >= array.getLength())
          addError(
              child, Error.INVALID_SUBSCRIPT, "Subscript value " + index + " is out of bounds");
        else value = array.get(index).getValue();
      }
      // Shouldn't happen
      catch (InterpreterException e) {
        addError(e.setContext(ctx));
   ...
   *
   * <p>{@link ASTInterpreter} does not support this by default - it should be overriden by classes
