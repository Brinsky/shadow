...
public final class Modifiers {
  ...
  */
  ...
  public String toDebugString() {
    ...
    if (isAssignable()) sb.append("[assignable] ");
    if (isTypeName()) sb.append("[type name] ");
    if (isField()) sb.append("[field] ");
    if (isTemporaryReadonly()) sb.append("[temporary readonly] ");
  ...
  public boolean hasModifier(Modifiers modifier) {
    return hasModifier(modifier.modifiers);
  }
