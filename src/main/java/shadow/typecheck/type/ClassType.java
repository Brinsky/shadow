...
public class ClassType extends Type {
  ...
  public List<Entry<String, ? extends ModifiedType>> orderAllFields() {
    List<Entry<String, ? extends ModifiedType>> fieldList =
        new ArrayList<Entry<String, ? extends ModifiedType>>();
  ...
  public Set<Entry<String, ? extends ModifiedType>> sortFields() {
    Set<Entry<String, ? extends ModifiedType>> set =
        new TreeSet<Entry<String, ? extends ModifiedType>>(
            new Comparator<Entry<String, ? extends ModifiedType>>() {
              @Override
              public int compare(
                  Entry<String, ? extends ModifiedType> first,
                  Entry<String, ? extends ModifiedType> second) {
  ...
  public ClassType replace(List<ModifiedType> values, List<ModifiedType> replacements)
    ...
    if (isRecursivelyParameterized()) {
      ...
      ClassType replaced =
          new ClassType(getTypeName(), getModifiers(), getDocumentation(), (ClassType) getOuter());
