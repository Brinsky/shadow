...
public class HtmlWriter {
  ...
  public HtmlWriter(Writer writer) throws ShadowException, DocumentationException {
  ...
  public void close() throws DocumentationException, ShadowException {
    if (openTags.isEmpty())
  ...
  public void closeLine() throws DocumentationException, ShadowException {
    close();
    out.write();
  }

  public void closeUntab() throws DocumentationException, ShadowException {
  ...
  public void add(String text) throws DocumentationException, ShadowException {
    if (openTags.isEmpty())
  ...
  public void addLine(String text) throws DocumentationException, ShadowException {
    add(text);
    out.write();
  }

  public void commentLine(String text) throws DocumentationException, ShadowException {
    String content = processContent(text);
    out.write("<!-- " + content + "-->");
  }
  ...
  public void full(String tagName, String text) throws DocumentationException, ShadowException {
    full(tagName, text, new Attribute[0]);
  }

  public void full(String tagName) throws DocumentationException, ShadowException {
  ...
  public void fullLine(String tagName, String text) throws DocumentationException, ShadowException {
    fullLine(tagName, text, new Attribute[0]);
  }

  public void fullLine(String tagName) throws DocumentationException, ShadowException {
  ...
  public void voidTag(String tagName) throws DocumentationException, ShadowException {
    voidTag(tagName, new Attribute[0]);
  }

  public void voidLine(String tagName) throws DocumentationException, ShadowException {
    voidLine(tagName, new Attribute[0]);
  }

  public void open(String tagName) throws DocumentationException, ShadowException {
    open(tagName, new Attribute[0]);
  }

  public void openLine(String tagName) throws DocumentationException, ShadowException {
    openLine(tagName, new Attribute[0]);
  }

  /* Helper methods */

  private void writeDoctype(String doctype) throws ShadowException, DocumentationException {
