...
/**
 * A simple node representing a compile-time constant field and containing its {@link
 * shadow.interpreter.ShadowValue} (as computed by {@link shadow.interpreter.ASTInterpreter}).
 */
